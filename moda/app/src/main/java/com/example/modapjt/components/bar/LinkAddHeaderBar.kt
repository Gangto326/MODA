...
fun LinkAddHeaderBar(
    ...
    TextField(
        ...
        modifier = modifier
            ...
            .border(1.dp, MaterialTheme.colorScheme.onSecondary, RoundedCornerShape(16.dp))  // 테두리 두께 1dp, 색상은 회색
...
//            .padding(vertical = 8.dp) // 위,아래 여백 8dp설정
        ...
        colors = TextFieldDefaults.colors(
            unfocusedContainerColor = MaterialTheme.colorScheme.tertiary, // 포커스가 없을 때 배경색
            focusedContainerColor = MaterialTheme.colorScheme.tertiary, // 포커스가 있을 때 배경색
