...
public class ImageService {
	...
	@Transactional
	public Boolean createImage(String userId, MultipartFile multipartFileImage) {
		UserId userIdObj = new UserId("user");
		String s3Url = imageStorageService.uploadMultipartFile(multipartFileImage);
		AIAnalysisResponseDTO aiAnalysisResponseDTO = pythonAiClient.imageAnalysis(s3Url);
